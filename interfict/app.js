// elm-watch hot {"version":"1.1.1","targetName":"Template","webSocketPort":59698}
"use strict";
(() => {
...
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return _Utils_Tuple2(
			{
				currentScene: $elm$core$Maybe$Nothing,
				images: $elm$core$Dict$empty,
				key: key,
				story: {scene: _List_Nil},
				texts: $elm$core$Dict$empty,
				url: url,
				viewMode: $author$project$Main$Library
			},
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Main$StoryLoaded = function (a) {
	return {$: 'StoryLoaded', a: a};
};
var $author$project$Main$ViewStory = {$: 'ViewStory'};
...
var $author$project$Main$Story = function (scene) {
	return {scene: scene};
};
var $author$project$Main$Scene = F3(
	function (home, name, route) {
		return {home: home, name: name, route: route};
	});
var $author$project$Main$SceneOption = F2(
	function (optionText, target) {
		return {optionText: optionText, target: target};
	});
...
var $author$project$Main$decodeSceneOption = A3(
	...
	A3(
		...
		'optionText',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Main$SceneOption)));
var $author$project$Main$decodeScene = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'route',
	$elm$json$Json$Decode$list($author$project$Main$decodeSceneOption),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'name',
		$elm$json$Json$Decode$string,
		A3(
			...
			'home',
			$elm$json$Json$Decode$string,
			$elm$json$Json$Decode$succeed($author$project$Main$Scene))));
var $author$project$Main$decodeStory = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'scene',
	$elm$json$Json$Decode$list($author$project$Main$decodeScene),
...
var $author$project$Main$getStory = function (message) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, message, $author$project$Main$decodeStory),
			url: 'story/scenes.json'
		});
};
var $author$project$Main$StoryImageFound = F2(
	function (a, b) {
		return {$: 'StoryImageFound', a: a, b: b};
	});
...
var $author$project$Main$getStoryImage = function (home) {
	return $elm$http$Http$get(
		{
...
var $author$project$Main$getStoryImages = function (story) {
	return $elm$core$Platform$Cmd$batch(
		A2(
			$elm$core$List$map,
			$author$project$Main$getStoryImage,
			A2(
				$elm$core$List$map,
				function ($) {
					return $.home;
...
var $author$project$Main$StoryTextLoaded = F2(
	function (a, b) {
		return {$: 'StoryTextLoaded', a: a, b: b};
	});
var $author$project$Main$getStoryText = function (home) {
	return $elm$http$Http$get(
		{
			expect: $elm$http$Http$expectString(
...
var $author$project$Main$getStoryTexts = function (story) {
	return $elm$core$Platform$Cmd$batch(
		A2(
			$elm$core$List$map,
			$author$project$Main$getStoryText,
			A2(
				$elm$core$List$map,
				function ($) {
					return $.home;
	...
	function (message, model) {
		switch (message.$) {
			case 'LoadStory':
				return _Utils_Tuple2(
					model,
					$author$project$Main$getStory($author$project$Main$StoryLoaded));
			case 'StoryLoaded':
				if (message.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								currentScene: $elm$core$List$head(story.scene),
								story: story,
								viewMode: $author$project$Main$ViewStory
							}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									$author$project$Main$getStoryTexts(story),
									$author$project$Main$getStoryImages(story),
									A2(
									...
									A2(
										...
										A2(
											...
											$elm$core$List$head(story.scene))))
								])));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'StoryTextLoaded':
				if (message.b.$ === 'Ok') {
					var home = message.a;
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								texts: A3($elm$core$Dict$insert, home, storyText, model.texts)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'StoryImageFound':
				if (message.b.$ === 'Ok') {
					var home = message.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								images: A3($elm$core$Dict$insert, home, home, model.images)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'UrlChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentScene: $elm$core$List$head(
								A2(
									$elm$core$List$filter,
									function (scene) {
										return _Utils_eq(scene.home, home);
									},
									model.story.scene)),
							url: url
						}),
...
var $author$project$Main$LoadStory = {$: 'LoadStory'};
var $author$project$Main$viewLibrary = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'display', 'flex'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick($author$project$Main$LoadStory)
				]),
			_List_fromArray(
				[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$GotoScene(sceneOption.target))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(sceneOption.optionText)
			]));
};
var $author$project$Main$viewOptions = function (sceneOptions) {
	return A2(
		...
		A2($elm$core$List$map, $author$project$Main$viewOption, sceneOptions));
};
var $author$project$Main$viewStory = function (model) {
	var title = A2(
		$elm$core$Maybe$withDefault,
		'??',
		A2(
	...
	var hasImage = function () {
		var _v0 = A2($elm$core$Dict$get, home, model.images);
		if (_v0.$ === 'Just') {
			return true;
		} else {
			return false;
	...
	var content = A2(
		$elm$core$Maybe$withDefault,
		'??',
		A2($elm$core$Dict$get, home, model.texts));
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src('story/images/' + (home + '.png')),
						A2($elm$html$Html$Attributes$style, 'width', '100%')
					]),
				...
				$author$project$Main$textToParagraphs(content)),
	...
	return {
		body: _List_fromArray(
			[
				...
				if (_v0.$ === 'Library') {
					return $author$project$Main$viewLibrary;
				} else {
					return $author$project$Main$viewStory(model);
				}
			}()
			]),
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Message","aliases":{"Main.Home":{"args":[],"type":"String.String"},"Main.Scene":{"args":[],"type":"{ home : Main.Home, name : String.String, route : List.List Main.SceneOption }"},"Main.SceneOption":{"args":[],"type":"{ optionText : String.String, target : Main.Home }"},"Main.Story":{"args":[],"type":"{ scene : List.List Main.Scene }"},"Main.StoryImage":{"args":[],"type":"String.String"},"Main.StoryText":{"args":[],"type":"String.String"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Message":{"args":[],"tags":{"LoadStory":[],"StoryLoaded":["Result.Result Http.Error Main.Story"],"StoryTextLoaded":["Main.Home","Result.Result Http.Error Main.StoryText"],"StoryImageFound":["Main.Home","Result.Result Http.Error Main.StoryImage"],"GotoScene":["Main.Home"],"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"NoOp":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));