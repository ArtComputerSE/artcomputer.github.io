...
var $author$project$Main$ViewCards = {$: 'ViewCards'};
...
var $author$project$Main$MaleAudience = {$: 'MaleAudience'};
...
var $author$project$Main$spicyToString = function (sp) {
	switch (sp.$) {
		case 'Green':
			return 'Green';
		case 'Yellow':
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			cards: $author$project$Main$getCards,
...
var $author$project$Main$RandomNumbersGenerated = function (a) {
	return {$: 'RandomNumbersGenerated', a: a};
};
var $author$project$Main$ViewGame = {$: 'ViewGame'};
...
var $author$project$Main$pickNextParticipant = function (model) {
	return _Utils_update(
		model,
		{
			currentParticipantIndex: (_Utils_cmp(
				model.currentParticipantIndex + 1,
...
var $author$project$Main$pickRandom = F2(
	function (random, list) {
		var index = $elm$core$Basics$round(
			random * ($elm$core$Array$length(list) - 1));
		return A2($elm$core$Array$get, index, list);
	});
...
var $author$project$Main$pickNextCard = F2(
	function (random, model) {
		return A2(
			$author$project$Main$pickPartner,
			random,
			A2(
				$author$project$Main$pickTruthOrDare,
				random,
				$author$project$Main$pickNextParticipant(model)));
	});
var $author$project$Main$RandomValues = F3(
	function (randomTruthDare, randomCard, randomPartner) {
		return {randomCard: randomCard, randomPartner: randomPartner, randomTruthDare: randomTruthDare};
	});
...
var $author$project$Main$randomGenerator = A4(
	$elm$random$Random$map3,
	F3(
		function (r1, r2, r3) {
			return A3($author$project$Main$RandomValues, r1, r2, r3);
		}),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		switch (msg.$) {
			case 'ChangedAudience':
				var audience = msg.a;
				var newSetting = _Utils_update(
					currentSetting,
					{
						audience: $elm$core$Maybe$Just(audience)
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ChangeRatio':
				...
				var newSetting = _Utils_update(
					currentSetting,
					{truthDareRatio: _float});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{setting: newSetting}),
					$elm$core$Platform$Cmd$none);
			case 'ChangedSpiciness':
				var spiciness = msg.a;
				var newSetting = _Utils_update(
					currentSetting,
					{
						spiciness: $elm$core$Maybe$Just(spiciness)
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{setting: newSetting}),
					$elm$core$Platform$Cmd$none);
			case 'ClickedNextRound':
				return _Utils_Tuple2(
					model,
					A2($elm$random$Random$generate, $author$project$Main$RandomNumbersGenerated, $author$project$Main$randomGenerator));
			case 'RandomNumbersGenerated':
				var numbers = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Main$pickNextCard, numbers, model),
					$elm$core$Platform$Cmd$none);
			...
			case 'ClickedViewCards':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{viewMode: $author$project$Main$ViewCards}),
					$elm$core$Platform$Cmd$none);
			case 'ClickedViewGame':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{viewMode: $author$project$Main$ViewGame}),
					$elm$core$Platform$Cmd$none);
			case 'ChangedCardTruthDare':
				var truthDare = msg.a;
				var currentEdit = model.editCard;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							editCard: _Utils_update(
								currentEdit,
								{
									truthDare: $elm$core$Maybe$Just(truthDare)
								})
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangedCardSpiciness':
				var spiciness = msg.a;
				var currentEdit = model.editCard;
				return _Utils_Tuple2(
					_Utils_update(
					...
					$elm$core$Platform$Cmd$none);
			case 'ChangedCardAudience':
				var audience = msg.a;
				var bool = msg.b;
				var currentEdit = model.editCard;
				var currentAudiences = model.editCard.audiences;
				var newAudiences = bool ? A2($Gizra$elm_all_set$EverySet$insert, audience, currentAudiences) : A2($Gizra$elm_all_set$EverySet$remove, audience, currentAudiences);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var $author$project$Main$ChangedCardAudience = F2(
	function (a, b) {
		return {$: 'ChangedCardAudience', a: a, b: b};
	});
var $author$project$Main$ChangedCardSpiciness = function (a) {
	return {$: 'ChangedCardSpiciness', a: a};
};
var $author$project$Main$ChangedCardText = function (a) {
	return {$: 'ChangedCardText', a: a};
};
var $author$project$Main$ChangedCardTruthDare = function (a) {
	return {$: 'ChangedCardTruthDare', a: a};
};
var $author$project$Main$ClickedAddCard = {$: 'ClickedAddCard'};
	...
	var truthDare = A2(
			...
			]),
		{
			label: A2(
				...
				$mdgriffith$elm_ui$Element$text('T/D')),
			onChange: $author$project$Main$ChangedCardTruthDare,
			options: _List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$Input$option,
					$author$project$Main$Truth,
					$mdgriffith$elm_ui$Element$text(
						$author$project$Main$truthDareToString($author$project$Main$Truth))),
					A2(
					$mdgriffith$elm_ui$Element$Input$option,
					$author$project$Main$Dare,
					$mdgriffith$elm_ui$Element$text(
						$author$project$Main$truthDareToString($author$project$Main$Dare)))
				]),
			selected: model.editCard.truthDare
		});
	var textField = A2(
			...
			]),
		{
			...
			onChange: $author$project$Main$ChangedCardText,
	...
	var spiciness = A2(
			...
			]),
		{
			label: A2(
				...
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$Font$bold]),
				$mdgriffith$elm_ui$Element$text('Spiciness')),
			onChange: $author$project$Main$ChangedCardSpiciness,
			options: _List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$Input$option,
					$author$project$Main$Green,
					...
					A2(
					$mdgriffith$elm_ui$Element$Input$option,
					$author$project$Main$Extreme,
					$mdgriffith$elm_ui$Element$text('Extreme'))
				]),
			selected: model.editCard.spiciness
		});
	var showAddButton = (!_Utils_eq(model.editCard.truthDare, $elm$core$Maybe$Nothing)) && ((!_Utils_eq(model.editCard.spiciness, $elm$core$Maybe$Nothing)) && ((!$Gizra$elm_all_set$EverySet$isEmpty(model.editCard.audiences)) && ($elm$core$String$length(model.editCard.text) > 0)));
	var audienceBox = function (a) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$checkbox,
			_List_Nil,
			{
				checked: A2($Gizra$elm_all_set$EverySet$member, a, model.editCard.audiences),
				...
				onChange: $author$project$Main$ChangedCardAudience(a)
			});
	};
	var audience = A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$Font$bold]),
				$mdgriffith$elm_ui$Element$text('Audiences')),
				audienceBox($author$project$Main$MixedAudience),
				audienceBox($author$project$Main$MaleAudience),
				audienceBox($author$project$Main$FemaleAudience)
			]));
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text('Add card'),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[truthDare, spiciness, audience, textField])),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$alignRight, $author$project$Main$buttonAttributes),
						{
							label: $mdgriffith$elm_ui$Element$text('Add card'),
							onPress: $elm$core$Maybe$Just($author$project$Main$ClickedAddCard)
						}) : $mdgriffith$elm_ui$Element$none
					]))
			]));
};
	...
	return A2(
		...
		$elm$core$List$concat(
			_List_fromArray(
				[
					_List_fromArray(
					[$author$project$Main$viewCardHeadings]),
					$elm$core$Array$toList(
					A2($elm$core$Array$map, $author$project$Main$viewCard, model.cards)),
					_List_fromArray(
					[
						$author$project$Main$viewAddCard(model)
					])
				])));
};
var $author$project$Main$ClickedViewCards = {$: 'ClickedViewCards'};
var $author$project$Main$ClickedViewGame = {$: 'ClickedViewGame'};
	...
	_List_fromArray(
		[
			...
			$author$project$Main$buttonAttributes,
			{
				...
				onPress: $elm$core$Maybe$Just($author$project$Main$ClickedViewGame)
			}),
			A2(
			$mdgriffith$elm_ui$Element$Input$button,
			$author$project$Main$buttonAttributes,
			{
				label: A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('Cards')),
	...
	function (maybeCard, partner) {
		if (maybeCard.$ === 'Nothing') {
			return A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('No card')
					]));
		} else {
			...
			[
				...
				_List_Nil,
				{
					label: A2(
						...
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Audience')),
					onChange: $author$project$Main$ChangedAudience,
					options: _List_fromArray(
						[
							A2(
							$mdgriffith$elm_ui$Element$Input$option,
							$author$project$Main$MixedAudience,
							$mdgriffith$elm_ui$Element$text('Mixed')),
							A2(
							$mdgriffith$elm_ui$Element$Input$option,
							$author$project$Main$MaleAudience,
							$mdgriffith$elm_ui$Element$text('Male')),
							A2(
							$mdgriffith$elm_ui$Element$Input$option,
							$author$project$Main$FemaleAudience,
							$mdgriffith$elm_ui$Element$text('Female'))
						]),
					selected: audience
				})
...
var $author$project$Main$ChangedSpiciness = function (a) {
	return {$: 'ChangedSpiciness', a: a};
};
var $author$project$Main$viewSpiciness = function (spiciness) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_Nil,
				{
					label: A2(
						...
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Spiciness')),
					onChange: $author$project$Main$ChangedSpiciness,
					options: _List_fromArray(
						[
							A2(
							$mdgriffith$elm_ui$Element$Input$option,
...
var $author$project$Main$viewSetting = function (setting) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$viewSpiciness(setting.spiciness),
						$author$project$Main$viewAudience(setting.audience),
						$author$project$Main$viewRatio(setting.truthDareRatio)
					]))
			]));
};
...
var $author$project$Main$viewAll = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				if (_v0.$ === 'ViewGame') {
					...
					return $author$project$Main$viewCards(model);
				}
			}()
			]));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		$author$project$Main$viewAll(model));
};
