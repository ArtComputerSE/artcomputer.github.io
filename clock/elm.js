...
var $author$project$Clock$clockWidth = '300px';
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'max-width', $author$project$Clock$clockWidth)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$svg$Svg$Attributes$width($author$project$Clock$clockWidth)
							]),
