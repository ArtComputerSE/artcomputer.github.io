...
var $author$project$Sudoku$Main$SetUp = {$: 'SetUp'};
var $author$project$Sudoku$Main$Model = F2(
	function (viewMode, grid) {
...
var $author$project$Sudoku$Main$decodeViewMode = A2(
	...
	function (s) {
		if (s === 'SetUp') {
			return $elm$json$Json$Decode$succeed($author$project$Sudoku$Main$SetUp);
		} else {
			return $elm$json$Json$Decode$succeed($author$project$Sudoku$Main$Solve);
		}
	},
...
var $author$project$Sudoku$Main$decodeModel = A3(
	...
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'viewMode',
		$author$project$Sudoku$Main$decodeViewMode,
...
var $author$project$Sudoku$Main$restoreModel = function (string) {
	...
	if (_v0.$ === 'Ok') {
		...
		return {
			...
			viewMode: $author$project$Sudoku$Main$SetUp
		};
	}
};
...
var $author$project$Sudoku$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Sudoku$Main$Help = {$: 'Help'};
...
var $author$project$Sudoku$Main$inSquare = function (_v0) {
	var row = _v0.row;
	var col = _v0.col;
	...
	function (sc, cell) {
		var squareConflict = 0 < $elm$core$List$length(
			A2(
				...
				function (s) {
					return _Utils_eq(
						$author$project$Sudoku$Main$inSquare(s),
...
var $perty$matrix$Matrix$map = F2(
	function (_function, matrix) {
		return A2(
			$elm$core$Array$map,
			$elm$core$Array$map(_function),
			matrix);
	});
...
var $author$project$Sudoku$Main$isSingleCell = function (cell) {
	return ($elm$core$Set$size(cell.options) === 1) ? $elm$core$Maybe$Just(
		{
			col: cell.col,
			row: cell.row,
			value: A2(
...
var $author$project$Sudoku$Main$singleCells = function (array) {
	return A2(
		$elm$core$List$filterMap,
		$author$project$Sudoku$Main$isSingleCell,
		$elm$core$List$concat(
			$elm$core$Array$toList(
				A2($elm$core$Array$map, $elm$core$Array$toList, array))));
};
var $author$project$Sudoku$Main$checkGrid = function (model) {
	var singles = $author$project$Sudoku$Main$singleCells(model.grid);
	var newGrid = A2(
		$perty$matrix$Matrix$map,
		$author$project$Sudoku$Main$checkCell(singles),
		model.grid);
	return _Utils_update(
		model,
		{grid: newGrid});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'constant',
				$elm$json$Json$Encode$bool(cell.constant))
			]));
};
...
var $author$project$Sudoku$Main$encodeViewMode = function (viewMode) {
	switch (viewMode.$) {
		case 'SetUp':
			return $elm$json$Json$Encode$string('SetUp');
		case 'Solve':
			return $elm$json$Json$Encode$string('Solve');
		default:
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'viewMode',
				$author$project$Sudoku$Main$encodeViewMode(model.viewMode)),
				_Utils_Tuple2(
				'grid',
...
var $perty$matrix$Matrix$set = F4(
	function (matrix, x, y, v) {
		var _v0 = A2($elm$core$Array$get, x, matrix);
		if (_v0.$ === 'Just') {
			var aCol = _v0.a;
			return A3(
				$elm$core$Array$set,
...
var $author$project$Sudoku$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ClickedCell':
				var x = msg.a;
				...
				var currentCell = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Sudoku$Main$emptyCell,
					A3($perty$matrix$Matrix$get, model.grid, x, y));
				var newSet = A2($elm$core$Set$member, option, currentCell.options) ? A2($elm$core$Set$remove, option, currentCell.options) : A2($elm$core$Set$insert, option, currentCell.options);
				...
				return _Utils_Tuple2(
					$author$project$Sudoku$Main$checkGrid(
						_Utils_update(
							model,
							{
								grid: $author$project$Sudoku$Main$initNonConstant(model.grid),
								viewMode: $author$project$Sudoku$Main$Solve
							})),
					$elm$core$Platform$Cmd$none);
			case 'PressedSetUp':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							grid: $author$project$Sudoku$Main$resetNonConstant(model.grid),
							viewMode: $author$project$Sudoku$Main$SetUp
						}),
					$elm$core$Platform$Cmd$none);
			case 'PressedHelp':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							grid: $author$project$Sudoku$Main$resetNonConstant(model.grid),
							viewMode: $author$project$Sudoku$Main$Help
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var cell = msg.a;
				var string = msg.b;
				var defaultCell = _Utils_update(
					cell,
					{constant: false, options: $elm$core$Set$empty});
				var defaultModel = _Utils_update(
					model,
					{
						grid: A4($perty$matrix$Matrix$set, model.grid, cell.row, cell.col, defaultCell)
					});
				var _v1 = $elm$core$String$toInt(
				...
				if (_v1.$ === 'Nothing') {
					...
					if ((n < 0) || (n > 9)) {
						...
						var newModel = _Utils_update(
							model,
							{
								grid: A4($perty$matrix$Matrix$set, model.grid, cell.row, cell.col, newCell)
							});
						return _Utils_Tuple2(
							newModel,
							$author$project$Sudoku$Main$saveModel(newModel));
...
var $author$project$Sudoku$Main$buttonAttr = _List_fromArray(
	[
...
var $author$project$Sudoku$Main$topRowAttributes = _List_fromArray(
	[
...
var $author$project$Sudoku$Main$viewHelp = A2(
	...
	_List_fromArray(
		[
			...
			$author$project$Sudoku$Main$topRowAttributes,
			_List_fromArray(
				[
					A2(
					...
					{
						label: $mdgriffith$elm_ui$Element$text('Solve'),
						onPress: $elm$core$Maybe$Just($author$project$Sudoku$Main$PressedDone)
					}),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
					$author$project$Sudoku$Main$buttonAttr,
					{
						label: $mdgriffith$elm_ui$Element$text('Set up'),
						onPress: $elm$core$Maybe$Just($author$project$Sudoku$Main$PressedSetUp)
					})
				])),
			A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('The Sudoku Notebook')
				])),
			A2(
			$mdgriffith$elm_ui$Element$paragraph,
			_List_Nil,
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('Start in Setup mode and enter your puzzle.  Press Done and you will be in Solve mode. The puzzle values will be in green.')
				])),
			A2(
			$mdgriffith$elm_ui$Element$paragraph,
			_List_Nil,
...
var $author$project$Sudoku$Main$defaultWidth = {bottom: 2, left: 2, right: 2, top: 2};
var $author$project$Sudoku$Main$borderBottomLeft = {
	round: _Utils_update(
...
var $author$project$Sudoku$Main$borderBottomMiddle = {
	round: $author$project$Sudoku$Main$defaultRound,
	width: _Utils_update(
		$author$project$Sudoku$Main$defaultWidth,
		{bottom: 4})
};
var $author$project$Sudoku$Main$borderMiddleLeft = {
	round: $author$project$Sudoku$Main$defaultRound,
	width: _Utils_update(
		$author$project$Sudoku$Main$defaultWidth,
		{left: 4})
};
var $author$project$Sudoku$Main$borderMiddleMiddle = {round: $author$project$Sudoku$Main$defaultRound, width: $author$project$Sudoku$Main$defaultWidth};
var $author$project$Sudoku$Main$borderMiddleRight = {
	round: $author$project$Sudoku$Main$defaultRound,
	width: _Utils_update(
		$author$project$Sudoku$Main$defaultWidth,
		{right: 4})
};
var $author$project$Sudoku$Main$borderTopLeft = {
	round: _Utils_update(
		$author$project$Sudoku$Main$defaultRound,
		{topLeft: 4}),
	width: _Utils_update(
...
var $author$project$Sudoku$Main$borderTopMiddle = {
	round: $author$project$Sudoku$Main$defaultRound,
	width: _Utils_update(
		$author$project$Sudoku$Main$defaultWidth,
		{top: 4})
};
var $author$project$Sudoku$Main$borderTopRight = {
	round: _Utils_update(
		$author$project$Sudoku$Main$defaultRound,
		{topRight: 4}),
	width: _Utils_update(
...
var $author$project$Sudoku$Main$helpButton = A2(
	$mdgriffith$elm_ui$Element$Input$button,
	_List_Nil,
	{
		label: A2(
			...
			_List_fromArray(
				[
					...
					{
						blur: 1,
						color: $author$project$Sudoku$Main$blue,
		...
		onPress: $elm$core$Maybe$Just($author$project$Sudoku$Main$PressedHelp)
	});
...
var $author$project$Sudoku$Main$ChangedSetUpCell = F2(
	function (a, b) {
		return {$: 'ChangedSetUpCell', a: a, b: b};
	});
...
var $author$project$Sudoku$Main$viewSetUpCell = function (cell) {
	var label = A2(
		$elm$core$Maybe$withDefault,
		' ',
		A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_Nil,
				{
					label: $mdgriffith$elm_ui$Element$Input$labelHidden('cell value'),
					onChange: $author$project$Sudoku$Main$ChangedSetUpCell(cell),
		...
		var getCell = F2(
			function (r, c) {
				return A2(
					$elm$core$Maybe$withDefault,
					$author$project$Sudoku$Main$emptyCell,
					A3($perty$matrix$Matrix$get, grid, r, c));
			});
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$centerX,
					$mdgriffith$elm_ui$Element$Border$widthEach(borders.width),
					$mdgriffith$elm_ui$Element$Border$roundEach(borders.round),
				...
				[
					...
					_List_fromArray(
						[
							...
							A2(getCell, sr + 1, sc)),
							$author$project$Sudoku$Main$viewSetUpCell(
							A2(getCell, sr + 1, sc + 1)),
							$author$project$Sudoku$Main$viewSetUpCell(
							A2(getCell, sr + 1, sc + 2))
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(getCell, sr + 2, sc)),
							$author$project$Sudoku$Main$viewSetUpCell(
							A2(getCell, sr + 2, sc + 1)),
							$author$project$Sudoku$Main$viewSetUpCell(
							A2(getCell, sr + 2, sc + 2))
						]))
				]));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$mdgriffith$elm_ui$Element$text('Set up')),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						$author$project$Sudoku$Main$buttonAttr,
						{
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Sudoku$Main$viewCell(
							A2(getCell, sr, sc)),
							$author$project$Sudoku$Main$viewCell(
							A2(getCell, sr, sc + 1)),
							$author$project$Sudoku$Main$viewCell(
...
var $author$project$Sudoku$Main$viewAll = function (model) {
	var _v0 = model.viewMode;
	switch (_v0.$) {
		case 'SetUp':
			return $author$project$Sudoku$Main$viewSetUp(model.grid);
		case 'Solve':
			return $author$project$Sudoku$Main$viewSolve(model.grid);
		default:
			return $author$project$Sudoku$Main$viewHelp;
	}
};
	...
	return A3(
		$mdgriffith$elm_ui$Element$layoutWith,
		{
			options: _List_fromArray(
				[
					$mdgriffith$elm_ui$Element$focusStyle($author$project$Sudoku$Main$noFocusStyle)
				])
		},
		_List_fromArray(
			[
...
_Platform_export({'Sudoku':{'Main':{'init':$author$project$Sudoku$Main$main($elm$json$Json$Decode$string)(0)}}});}(this));