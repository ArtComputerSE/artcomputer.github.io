...
var $author$project$Sudoku$Main$emptyCell = {col: 0, conflict: false, options: $elm$core$Set$empty, row: 0};
...
var $author$project$Sudoku$Main$viewGrid = function (grid) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Sudoku$Main$viewAll = function (model) {
	return $author$project$Sudoku$Main$viewGrid(model.grid);
};
