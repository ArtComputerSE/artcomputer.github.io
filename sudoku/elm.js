...
_Platform_export({'Sudoku':{'Main':{'init':$author$project$Sudoku$Main$main($elm$json$Json$Decode$string)({"versions":{"elm":"0.19.1"},"types":{"message":"Sudoku.Main.Msg","aliases":{"Sudoku.Main.Cell":{"args":[],"type":"{ row : Basics.Int, col : Basics.Int, options : Set.Set Basics.Int, conflict : Basics.Bool, constant : Basics.Bool }"}},"unions":{"Sudoku.Main.Msg":{"args":[],"tags":{"ClickedCell":["Basics.Int","Basics.Int","Basics.Int"],"PressedResetCell":["Sudoku.Main.Cell"],"PressedDone":[],"PressedSetUp":[],"ChangedSetUpCell":["Sudoku.Main.Cell","String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Set.Set":{"args":["t"],"tags":{"Set_elm_builtin":["Dict.Dict t ()"]}},"String.String":{"args":[],"tags":{"String":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}}});}(this));