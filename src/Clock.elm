module Clock exposing (Model, Msg(..), TimeOfDay, clockFace, clockFn, dateFromPosix, hourHand, hourMinute, init, main, minuteToAngle, minutesHand, second, secondsHand, subscriptions, tick, tickMarks, update, view, xLine)
